...
try:
    ...
    data = pd.read_csv("venv\csv_parquet\i2do_enpoint.csv")
...
data_final = pd.read_csv("venv\csv_parquet\i4to_endpoint.csv")
...
# Leer el archivo CSV
data = pd.read_csv("venv\csv_parquet\datos_finales2.csv")
...
df = pd.read_csv("venv\csv_parquet\ml.csv")
